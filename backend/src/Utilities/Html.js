const dynamicEmail = (company_Name, link) => {
    return `
        ...
        <div style="max-width: 600px; margin: 0 auto;">
          ...
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
              ...
              <td valign="middle" style="padding: 3em 0 2em 0;">
                <img src="https://res.cloudinary.com/dheu5jnjj/image/upload/v1709054552/dgwkyt18elggcszvcbkx.png" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
              </td>
              </tr><!-- end tr -->
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome On Board , ${company_Name}.<br/>Kindly confirm your OTP.</h3>
                                <p><a href="" class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 
                                3px; background: #7e2e00; color: #ffffff; text-decoration: none;"><button>${link}</button></a></p>
